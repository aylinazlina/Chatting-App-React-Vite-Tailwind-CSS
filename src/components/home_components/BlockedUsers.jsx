      ...
      <div className="w-[25dvw] h-[43dvh] mt-9 rounded-xl border-2 border-gray-200 shadow-xl overflow-hidden">
        <div className="flex  py-2">
          <p className="ml-6 font-roboto_font font-bold text-[18px]">
            Blocked Users({groups.length})
          </p>
          <span className="font-roboto_font font-bold text-[22px] mt-2 text-secondary_color ml-40">
            <HiDotsVertical />
          </span>
        </div>
          ...
          <div
            className={
              item.id === groups.length
                ? `flex justify-around  pb-15 mt-2 cursor-pointer`
